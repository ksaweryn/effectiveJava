...
public class NutritionFacts_BP {
    ...
    public NutritionFacts_BP(int servingSize){
        //Empty constructor
    }


    public static void main(String[] args) {
        NutritionFacts_BP cocaCola = new NutritionFacts_BP.Builder(240, 8).calories(100).sodium(35).carbohydrate(27).build();
        System.out.println(cocaCola);
    }

    @Override
    public String toString() {
        return "Servinsize: " + servingSize + ", serving: " + serving + ", calories: " + calories + ", fat: "
